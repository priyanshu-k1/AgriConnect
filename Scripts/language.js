...
const translations = {
  en: {
    ...
    aboutText1:
      "Welcome to AgriConnect, your trusted partner in farming and agriculture!",
    aboutText2:
      "At AgriConnect, we are committed to empowering farmers with knowledge and resources to grow a better tomorrow. Our goal is to support you in making informed decisions about crops, their requirements, and effective agricultural practices—all in the language you are most comfortable with: English, Hindi, and Telugu.",
    aboutText3:
...
function changePayButton(amount) {
  try {
    ...
    // Replace with your actual logic for generating a random number
